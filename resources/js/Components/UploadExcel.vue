  ...
  <h1 class="text-xl font-semibold text-blue-800 max-md:mb-2 pt-5">
    ...
    >
        <div class="flex items-center gap-5">
            <label for="file" class="bg-blue-500 px-3 py-2 whitespace-nowrap text-white">
                <input
                    type="file"
                    id="file"
        ...
        <button class="bg-blue-200 text-white px-3 py-2 rounded-md max-md:w-full" :disabled="form.file.length == 0" :class="{'bg-blue-500' : form.file.length != 0}">
            submit
        </button>
    </form>
  </div>
